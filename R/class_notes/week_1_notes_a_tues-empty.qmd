...
- the process of retrieving revelant data from a source
...
- a format where each variable forms a column, each observation forms a row and each type form a table
...
* ____(quantitative)
* ____ (text or categorical)
* ____ (TRUE/FALSE)

Q4. What is the definition of a data frame?
- A two dimenstional table where each column is a variable and each row is an observation
...
- It is the capacity to maniplualate the data to eventually anaylyze or visulize
...
- Provide the ability to extract rows based on a condition
...
- Allow us to create a new variable within the frame data
...
- Data visualization is the graphic reprensation of data to communicate information clearly efficient


#### Sub Task 1

*Create a histogram of **IMDB\_Rating***
...
*Scatter plot of **IMDB\_Rating** vs **Gross** for movies from 2000 onward*
